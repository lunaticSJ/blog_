...
class Config(object):
    ...
    ADMIN_NAME = '02'
    # 管理员登录信息
    ADMIN_LOGIN_NAME = 'kuxiu_admin'
    # 登录密码
    ADMIN_PASSWORD = '9858123sj'
    # 博客名
    SITE_NAME = '02'
    # 博客标题
    SITE_TITLE = '02'
    # 管理员简介
    ADMIN_PROFILE = ' python '
...
class DevelopmentConfig(Config):
    SQLALCHEMY_DATABASE_URI = 'mysql+pymysql://root:123456@115.159.95.124:3306/TestTable'
    DEBUG = True
